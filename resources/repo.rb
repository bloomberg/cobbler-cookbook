...
attribute :os_breed, kind_of: String, required: true, default: 'yum'
...
attribute :apt_components, kind_of: String, required: false, default: nil
attribute :apt_dist_names, kind_of: String, required: false, default: nil
...
attribute :yum_options, kind_of: Hash, required: false, default: nil
