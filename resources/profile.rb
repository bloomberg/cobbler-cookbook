...
attribute :distribution, kind_of: String, required: false, default: nil
...
attribute :owners, kind_of: String, required: false, default: nil
...
attribute :repos, kind_of: String, required: false, default: nil
