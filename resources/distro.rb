...
# Valid options
attribute :breed, kind_of: String, required: true, default: nil
# Valid options
...
attribute :kernel_options, kind_of: Array, required: false, default: nil
attribute :kernel_options_postinstall, kind_of: Array, required: false, default: nil
attribute :kickstart_meta, kind_of: String, required: false, default: nil
